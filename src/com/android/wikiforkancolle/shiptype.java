...
public class shiptype extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		case R.id.AS:
			...
			taigei.setOnClickListener(new OnClickListener() {			
				...
				public void onClick(View v) {
					Intent intent_shipdetails = new Intent(shiptype.this, shipdata.class);
		...
		case R.id.AV:
			...
			ImageButton zuiho = (ImageButton) findViewById(R.id.zuiho);
			zuiho.setOnClickListener(new OnClickListener() {			
				@Override
				public void onClick(View v) {
					Intent intent_shipdetails = new Intent(shiptype.this, shipdata.class);
					intent_shipdetails.putExtra("shipdata", R.id.zuiho);
					startActivity(intent_shipdetails);	
				}
			});
			break;
		case R.id.BB:
			...
			ImageButton bismaick = (ImageButton) findViewById(R.id.bismaick);
			bismaick.setOnClickListener(new OnClickListener() {			
				@Override
				public void onClick(View v) {
					Intent intent_shipdetails = new Intent(shiptype.this, shipdata.class);
					intent_shipdetails.putExtra("shipdata", R.id.bismaick);
					startActivity(intent_shipdetails);	
				}
			});
