...
import com.android.wikiforkancolle.MainActivity;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	private static final String DATABASE_NAME = "kancolle.db";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		copyFileFromAssets(mContext, DATABASE_PATH, DATABASE_NAME);
	}
	...
	// AlertDialog.Builder builder = new AlertDialog.Builder(this);
	// builder.setTitle("练习航海");
	// builder.setMessage("远征1要求：balabala");
